                      ...
                      <form id="formAccountSettings" method="POST" onsubmit="return false">
                        <div class="row">
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <input class="form-control" type="text" id="profession" name="profession" placeholder="Teacher" />
                          </div>

                          <div class="mb-3 col-md-6">
                            <label for="birthday" class="form-label">Death of birth</label>
                            <input class="form-control" type="date" id="birthday" name="dob" placeholder="16-12-2002" />
                          </div>
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <input class="form-control" type="text" id="role" name="role" placeholder="user"/>
                          </div>
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <input class="form-control" type="text" id="last_login" name="last_login"/>
                          </div>
